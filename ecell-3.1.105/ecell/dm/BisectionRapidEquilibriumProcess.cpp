...
LIBECS_DM_CLASS( BisectionRapidEquilibriumProcess, Process )
{
...
#ifdef _MSC_VER
  LIBECS_API BisectionRapidEquilibriumProcess * getInstance()
  {
      return new BisectionRapidEquilibriumProcess();
  }
#endif
  protected:
 ...
 public:
  ...
  VariableReferencePtr getMinProductPtr()
    {
      Integer anIndex = (Integer)getPositiveVariableReferenceOffset();
