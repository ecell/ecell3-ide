...
namespace Ecell
{
    ...
    /// </summary>
    [TestFixture()]
    public class TestEmlParseException
    {

        private EmlParseException _unitUnderTest;
        /// <summary>
        /// 
        /// </summary>
        [SetUp()]
        ...
        /// </summary>
        [Test()]
        public void TestConstructorEmlParseExceptionMsg()
        {
            string msg = "Error";
            EmlParseException testEmlParseException = new EmlParseException(msg);
