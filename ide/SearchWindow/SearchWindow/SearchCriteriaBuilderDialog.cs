...
namespace Ecell.IDE.Plugins.SearchWindow
{
    ...
    /// </summary>
    internal partial class SearchCriteriaBuilderDialog : Form
    {
        #region Fields
        /// <summary>
        ...
        /// <summary>
        /// the constructor for SearchCriteriaBuilderDialog.
        /// </summary>
        public SearchCriteriaBuilderDialog(SearchWindow owner)
        {
            m_owner = owner;
            InitializeComponent();
        }
        ...
        /// <param name="e">EventArgs.</param>
        private void SearchCriteriaBuilderDialogShown(object sender, EventArgs e)
        {
            this.idText.Focus();
        }
