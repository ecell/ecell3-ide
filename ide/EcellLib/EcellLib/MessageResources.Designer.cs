...
namespace Ecell {
    ...
    internal class MessageResources {
        ...
        /// <summary>
        ///   Cannot save the action file. に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   Cannot save the script file. に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   Cannot retrive the property value {0} under the simulation. に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   The logging policy of {0} was updated. に類似しているローカライズされた文字列を検索します。
        /// </summary>
