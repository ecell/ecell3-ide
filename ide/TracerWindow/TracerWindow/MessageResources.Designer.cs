...
namespace Ecell.IDE.Plugins.TracerWindow {
    ...
    internal class MessageResources {
        ...
        /// <summary>
        ///   Save this project before saving the simulation log. に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   The log data is not exist in {0}. に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string WarnNoLog {
            get {
                return ResourceManager.GetString("WarnNoLog", resourceCulture);
            }
        }
    }
}
