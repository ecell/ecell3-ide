...
namespace Ecell.IDE.Plugins.PathwayWindow.Figure
{
    ...
    public class DiamondFigure : FigureBase
    {
        ...
        /// Figure type.
        /// </summary>
        public new const string TYPE = "Diamond";
        ...
        public DiamondFigure(float x, float y, float width, float height)
        {
        ...
        private static PointF[] GetPoints(float x, float y, float width, float height)
        {
            ...
            PointF point1 = new PointF(x, halfY);
            PointF point2 = new PointF(halfX, y);
            PointF point3 = new PointF(x + width, halfY);
            PointF point4 = new PointF(halfX, y + height);
